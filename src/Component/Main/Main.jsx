    ...
    <section className="bg-gradient-to-r from-blue-50 to-purple-100 py-20">
        <div className="container mx-auto text-center">
            ...
            <div className="flex justify-center">
                ...
                <button className="px-6 py-2 bg-blue-600 text-white rounded-r-md hover:bg-blue-500">Book a Demo
                </button>
            </div>
...
const CTA = () => (
    ...
    <section className="bg-gradient-to-r from-blue-50 to-purple-100 py-20">
        <div className="container mx-auto text-center">
            ...
            <button className="px-8 py-3 bg-blue-600 text-white rounded-full hover:bg-blue-500">Try for free
            </button>
        </div>
    </section>
)
